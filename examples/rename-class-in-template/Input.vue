<template>
  <div :class="containerClassNames">
    <blockquote :class="quoteClassNames">
      <IconQuote size="medium" /> and when we speak we are afraid<br />
    ...
    <button type="button">Share poem</button>
  </div>
</template>
...
const containerClassNames = tw`flex-4 min-h-16 w-24`
const quoteClassNames = tw`p-40`
</script>
